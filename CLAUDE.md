...
dùng vừa giả được vừa bị nhốt chung một ngăn giới hạn tốc độ. Cộng tất cả: **107 lỗi, đã sửa 105**; hai mục còn lại (thiếu chức
...
| Tài liệu | Nội dung |
|---|---|
| `docs/08-so-loi.md` | Sổ lỗi sáu đợt: 37 lỗi hai đợt đầu, 5 lỗi đợt rà thứ hai (mục E), 9 lỗi đợt áp bản thiết kế (mục G), 7 lỗi đợt rà thứ ba (mục H), 8 lỗi đợt triển khai (mục I), **48 lỗi đợt rà hoàn thiện 04/09/2026 (mục J, chia theo phân hệ: J, J.C, J.B, J.L, J.D, J.X)** |
