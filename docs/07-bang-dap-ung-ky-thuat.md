...
| II.6 | Nhập dữ liệu từ biểu ghi ISO 2709 | **Có** | Luồng bốn bước: chọn tệp, xem trước kèm đối chiếu trùng, chọn cách xử lý trùng và nơi để bản sách, chạy nền có tiến trình và nhật ký lỗi từng biểu ghi. Bốn cách xử lý trùng và ba cách đối chiếu. Một biểu ghi hỏng trong tệp chỉ làm hỏng chính nó: biểu ghi lành đứng sau vẫn vào, biểu ghi bị từ chối không lọt vào kho, và tác vụ chạy hết tệp (sửa 07/09/2026 — sổ lỗi L5) | Kịch bản BM.21 → BM.27, TD.6 |
...
| C18 | Responsive: quản trị tối thiểu 1366×768, OPAC hỗ trợ mobile | **Có** | Thiết kế cho 1366×768; từ 992px trở xuống menu chuyển thành ngăn kéo, các khối xếp dọc và bảng nhiều cột cuộn trong khung của nó. Trang tra cứu ở khổ điện thoại: tên thư viện co và cắt bằng dấu ba chấm, nhãn nút rút gọn, trang chi tiết xếp dọc | Đo `scrollWidth − clientWidth` **đúng ở 1366×768** trên máy chủ thật: 58 đường dẫn quản trị + 67 phép đo theo thẻ, tất cả bằng 0 (kịch bản RS.1–RS.2). Trang tra cứu đo ở **375×812**: 23 đường dẫn công khai + 15 phép đo ở trạng thái đã đăng nhập, tất cả bằng 0 (kịch bản RT.1–RT.7). Phép thử `styles.phone.test.tsx` canh lại luật |
