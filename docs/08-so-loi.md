...
được đếm là "đang dùng" nên không xoá được tác giả). Cả 15 đã sửa trong ngày.
...
**147 lỗi, đã sửa 145**; thêm **15 lỗi của đợt nghiệm thu thử, test sâu và ba đợt test kỹ thuật trên máy
chủ thật ngày 05/09/2026 (mục K), đã sửa cả 15** — tổng **162 lỗi, đã sửa 162**. Hai mục H3 và H9 đã làm xong ngày 03/09/2026 và ghi ở cột cuối
