...
| I7 | Nhẹ | Chỉnh **chủ đề và cỡ chữ nằm sau bức tường đăng nhập** — khách không đổi được | Thẻ Tài khoản nằm trong `_protected` của bộ định tuyến, mà hai tuỳ chọn ấy chỉ có ở đó. Phát hiện khi viết phép thử iOS: khách bấm Tài khoản bị đưa sang trang đăng nhập. | Chưa sửa. Cỡ chữ và chế độ tối là tuỳ chọn trợ năng, đáng ra khách cũng dùng được; nên tách khối cài đặt hiển thị ra khỏi nhóm cần đăng nhập. Ghi ở "Làm tiếp gì sau đây". |
...
1. **Tuỳ chọn hiển thị nằm sau đăng nhập** (I7): chế độ tối và cỡ chữ chỉ có trong thẻ Tài khoản,
   mà thẻ ấy đòi đăng nhập. Tách khối cài đặt hiển thị ra chỗ khách cũng vào được.
