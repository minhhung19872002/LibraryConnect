...
2. **Phục hồi cơ sở dữ liệu vẫn chạy trong lượt HTTP.** Cùng lớp lỗi với H9 nhưng chưa chạm tới:
   `pg_restore` một kho lớn cũng vượt 300 giây. Khác H9 ở chỗ người dùng phải đứng chờ kết quả mới
   biết hệ thống còn dùng được hay không, nên cần thiết kế lại màn hình chứ không chỉ đổi chỗ chạy.
