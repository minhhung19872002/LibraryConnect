...
`sickle` cho OAI-PMH, `pymarc` cho MARCXML — thì OAI-PMH đạt cả sáu verb, còn SRU lộ K20. Cả 20 đã sửa.
...
**147 lỗi, đã sửa 145**; thêm **20 lỗi của đợt nghiệm thu thử, test sâu, ba đợt test kỹ thuật ngày
05/09/2026 và hai đợt soi nghiệp vụ – giao thức ngày 06/09/2026 (mục K), đã sửa cả 20** — tổng **167 lỗi, đã sửa 167**. Hai mục H3 và H9 đã làm xong ngày 03/09/2026 và ghi ở cột cuối
