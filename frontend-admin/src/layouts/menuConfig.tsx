...
export const menuTree: MenuNode[] = [
  ...
  },
  {
    ...
    icon: <GlobalOutlined />,
    permissions: [
      PERMISSIONS.cms.settingManage,
      PERMISSIONS.cms.pageManage,
      PERMISSIONS.cms.newsView,
      PERMISSIONS.cms.galleryManage,
      PERMISSIONS.cms.reviewModerate,
    ],
    children: [
      {
        key: 'cms-site',
        label: messages.menu.cmsSite,
        icon: <SettingOutlined />,
        path: '/noi-dung/thong-tin',
        permissions: [PERMISSIONS.cms.settingManage],
      },
      {
        key: 'cms-pages',
        label: messages.menu.cmsPages,
        icon: <FileTextOutlined />,
        path: '/noi-dung/trang',
        permissions: [PERMISSIONS.cms.pageManage],
      },
      {
        key: 'cms-news',
        label: messages.menu.cmsNews,
        icon: <ProfileOutlined />,
        path: '/noi-dung/tin-tuc',
        permissions: [PERMISSIONS.cms.newsView],
      },
      {
        key: 'cms-galleries',
        label: messages.menu.cmsGalleries,
        icon: <AppstoreOutlined />,
        path: '/noi-dung/thu-vien-anh',
        permissions: [PERMISSIONS.cms.galleryManage],
      },
      {
        key: 'cms-reviews',
        label: messages.menu.cmsReviews,
        icon: <AuditOutlined />,
        path: '/noi-dung/nhan-xet',
        permissions: [PERMISSIONS.cms.reviewModerate],
      },
    ],
  },
  {
