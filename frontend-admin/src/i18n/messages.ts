...
export const messages = {
  ...
  menu: {
    ...
    bibExcelImport: 'Nhập biểu ghi từ Excel',
    ...
    catalogingConfig: 'Cấu hình biên mục',
    ...
    digital: 'Tài liệu số',
    digitalDocuments: 'Kho tài liệu số',
    ...
    readerImport: 'Nhập xuất dữ liệu bạn đọc',
    readerReports: 'Báo cáo bạn đọc',
    ...
    cmsSite: 'Thông tin trang thư viện',
    cmsPages: 'Trang tĩnh',
    cmsNews: 'Tin tức – sự kiện',
