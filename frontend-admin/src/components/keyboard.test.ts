 ...
 *
 * Luật này sinh ra ở `frontend-opac` và suốt một thời gian chỉ canh đúng thư mục ấy — trong khi
 * giao diện quản trị là nơi cán bộ ngồi cả ngày và mục 6.6 đòi thao tác được bằng bàn phím ở cả
 * hai. Đo ngày 08/09/2026: quản trị hiện **không có** `div`/`span` nào gắn `onClick`, tức là đang
 * đạt; bản sao này giữ cho chỗ đầu tiên trong tương lai không lọt (bài học 9).
 *
