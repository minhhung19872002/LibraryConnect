 ...
 *
 * Đã xảy ra thật ở giao diện quản trị: bảy lớp được gắn vào phần tử mà chưa bao giờ có kiểu, nên
 * hàng đang chọn ở màn hình Quản lý kho không sáng lên và dòng nhập sai trong tệp bạn đọc không đỏ.
 *
 * Chiều ngược lại — khai mà không dùng — nhẹ hơn nhưng vẫn đáng chặn: `lc-cover--placeholder` ở
 * đây từng nằm lại sau khi bìa thay thế chuyển sang cho máy chủ dựng, và người đọc tệp về sau
 * tưởng nó vẫn đang vẽ ra cái gì đó.
 */
