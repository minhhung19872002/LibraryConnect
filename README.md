...
```bash
cd backend && dotnet test          # 304 unit test + 247 integration test
cd frontend-admin && npm test      # 97 test giao diện
```
...
| 11 | Liên thư viện: Z39.50, SRU, OAI-PMH | 🔄 Đang thực hiện |
